...
//       JOB            NAME                                            TYPE                                                                                                                                                                            GOG ADDR        STEAM ADDR
	...
	{OJ_DEFINE,	"Trade_Net_set_unit_path",		"int (__fastcall *) (Trade_Net * this, int edx, int from_x, int from_y, int to_x, int to_y, Unit * unit, int civ_id, int flags, int * out_path_length_in_mp)",	0x580540,	0x0},
	{OJ_DEFINE,	"Unit_pop_next_move_from_path",		"byte (__fastcall *) (Unit * this)",																0x5B3290,	0x0},
	{OJ_INLEAD,	"Unit_ai_move_leader",			"void (__fastcall *) (Unit * this)",																0x45FED0,	0x0},
	...
	{OJ_DEFINE,	"Unit_next_escorter_id",		"int (__fastcall *) (Unit * this, int edx, int * index, byte begin_iterating)",											0x5B2B20,	0x0},
	{OJ_DEFINE,	"Unit_can_hurry_production",		"byte (__fastcall *) (Unit * this, int edx, City * city, byte exclude_cheap_improvements)",									0x5C00A0,	0x0},
	{OJ_DEFINE,	"Unit_disband",				"void (__fastcall *) (Unit * this)",																0x5BC300,	0x0},
	{OJ_DEFINE,	"Unit_hurry_production",		"void (__fastcall *) (Unit * this)",																0x5C0420,	0x0},
	{OJ_DEFINE,	"Unit_ai_can_start_science_age",	"byte (__fastcall *) (Unit * this)",																0x5C0300,	0x0},
	{OJ_DEFINE,	"Unit_start_science_age",		"void (__fastcall *) (Unit * this)",																0x5C03B0,	0x0},
	{OJ_DEFINE,	"Unit_ai_can_form_army",		"byte (__fastcall *) (Unit * this)",																0x5BC980,	0x0},
	{OJ_DEFINE,	"Unit_form_army",			"Unit * (__fastcall *) (Unit * this)",																0x5BCA20,	0x0},
	{OJ_REPL_VPTR,	"impl_ai_is_good_army_addition",	"byte (__fastcall *) (Unit * this, int edx, Unit * candidate)",													0x66DD28,	0x0},
