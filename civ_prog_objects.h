...
//       JOB            NAME                                            TYPE                                                                                                                                                                            GOG ADDR        STEAM ADDR
	...
	{OJ_DEFINE,	"ADDR_ADDR_OUTPUTDEBUGSTRINGA",			"void *",																					0x665188,	0x68219C},
	{OJ_DEFINE,	"ADDR_ADDR_GETASYNCKEYSTATE",			"void *",																					0x665280,	0x6822E0},
	{OJ_DEFINE,	"ADDR_ADDR_GETPROCADDRESS",			"void *",																					0x665168,	0x682130},
	{OJ_DEFINE,	"ADDR_ADDR_GETMODULEHANDLEA",			"void *",																					0x6650E4,	0x6820B8},
	{OJ_REPL_VPTR,	"init_floating_point",				"void (__stdcall *) (void)",																			0x73A8FC,	0x756C74},
	{OJ_DEFINE,	"ADDR_STEALTH_ATTACK_TARGET_COUNT_CHECK",	"void *",																					0x5B6B01,	0x5C5458},
	{OJ_DEFINE,	"ADDR_UNIT_COUNT_CHECK",			"void *",																					0x569503,	0x575933},
	{OJ_DEFINE,	"ADDR_ERA_COUNT_CHECK",				"void *",																					0x594B35,	0x5A2357},
	{OJ_DEFINE,	"ADDR_SUB_BUG_PATCH",				"void *",																					0x57F623,	0x58C352},
	{OJ_DEFINE,	"ADDR_SCIENCE_AGE_BUG_PATCH",			"void *",																					0x5601EF,	0x56C2E3},
	{OJ_DEFINE,	"ADDR_PEDIA_TEXTURE_BUG_PATCH",			"void *",																					0x4CD0B1,	0x4D5151},
	{OJ_DEFINE,	"ADDR_AUTORAZE_BYPASS",				"void *",																					0x5640AC,	0x570385},
	{OJ_REPL_VPTR,	"Leader_impl_would_raze_city",			"byte (__fastcall *) (Leader * this, int edx, City * city)",															0x66CB50,	0x689C3C},
	{OJ_REPL_VPTR,	"Main_Screen_Form_handle_left_click_on_map_1",	"void (__fastcall *) (Main_Screen_Form * this, int edx, int param_1, int param_2)",												0x66B44C,	0x68854C},
	...
	{OJ_DEFINE,	"p_trade_net",					"Trade_Net *",																					0xB72888,	0xB950A8},
	{OJ_DEFINE,	"Trade_Net_set_unit_path",			"int (__fastcall *) (Trade_Net * this, int edx, int from_x, int from_y, int to_x, int to_y, Unit * unit, int civ_id, int flags, int * out_path_length_in_mp)",			0x580540,	0x58D270},
	{OJ_DEFINE,	"Unit_pop_next_move_from_path",			"byte (__fastcall *) (Unit * this)",																		0x5B3290,	0x5C1BE0},
	{OJ_INLEAD,	"Unit_ai_move_leader",				"void (__fastcall *) (Unit * this)",																		0x45FED0,	0x4622A0},
	{OJ_DEFINE,	"Unit_next_escorter_id",			"int (__fastcall *) (Unit * this, int edx, int * index, byte begin_iterating)",													0x5B2B20,	0x5C1440},
	{OJ_DEFINE,	"Unit_disband",					"void (__fastcall *) (Unit * this)",																		0x5BC300,	0x5CAE50},
	{OJ_DEFINE,	"Unit_can_hurry_production",			"byte (__fastcall *) (Unit * this, int edx, City * city, byte exclude_cheap_improvements)",											0x5C00A0,	0x5CEC20},
	{OJ_DEFINE,	"Unit_hurry_production",			"void (__fastcall *) (Unit * this)",																		0x5C0420,	0x5CEFC0},
	{OJ_DEFINE,	"Unit_ai_can_start_science_age",		"byte (__fastcall *) (Unit * this)",																		0x5C0300,	0x5CEE90},
	{OJ_DEFINE,	"Unit_start_science_age",			"void (__fastcall *) (Unit * this)",																		0x5C03B0,	0x5CEF50},
	{OJ_DEFINE,	"Unit_ai_can_form_army",			"byte (__fastcall *) (Unit * this)",																		0x5BC980,	0x5CB510},
	...
	{OJ_REPL_VPTR,	"DiploForm_m68_Show_Dialog",		"int (__fastcall *) (DiploForm * this, int edx, int param_1, void * param_2, void * param_3)",																		0x66C1E8,	0x6892D8},
	{OJ_REPL_VPTR,	"DiploForm_m82_handle_key_event",	"void (__fastcall *) (DiploForm * this, int edx, int virtual_key_code, int is_down)",																			0x66C220,	0x689310},
	{OJ_DEFINE,	"p_player_bits",			"unsigned *",																												0xA526C0,	0xA74EB8},
	{OJ_DEFINE,	"DiploForm_close",			"void (__fastcall *) (DiploForm *)",																									0x50D830,	0x517970},
	{OJ_INLEAD,	"DiploForm_do_diplomacy",		"void (__fastcall *) (DiploForm * this, int edx, int diplo_message, int param_2, int civ_id, int do_not_request_audience, int war_negotiation, int disallow_proposal, TradeOfferList * our_offers, TradeOfferList * their_offers)",	0x505F40,	0x50FD30},
	{OJ_DEFINE,	"Leader_ai_would_meet_with",		"byte (__fastcall *) (Leader * this, int edx, int civ_id)",																						0x440E10,	0x442C00},
	{OJ_REPL_VPTR,	"DiploForm_m22_Draw",			"void (__fastcall *) (DiploForm * this)",																								0x66C130,	0x689220},
	{OJ_DEFINE,	"Button_construct",			"Button * (__fastcall *) (Button * this)",																								0x609F50,	0x623C40},
	{OJ_DEFINE,	"Button_initialize",			"int (__fastcall *) (Button * this, int edx, char * param_1, int control_id, int x, int y, int width, int height, Base_Form * parent, int param_8)",											0x60B050,	0x625450},
	{OJ_DEFINE,	"DiploForm_set_their_message",		"int (__fastcall *) (DiploForm * this, int edx, DiploMessage msg, int message_arg, int param_3)",																	0x5161C0,	0x51F9B0},
	{OJ_DEFINE,	"DiploForm_reset_our_message_choices",	"void (__fastcall *) (DiploForm *)",																									0x516260,	0x51FA50},
