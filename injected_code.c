...
load_trade_net_refs ()
{
	...
	is->trade_net_refs = calloc (315, sizeof is->trade_net_refs[0]);
	...
	int const addrs[315] = {// 282 direct references to trade net location
		0x57D820, 0x57D7E7, 0x45D70F, 0x453724, 0x46316D, 0x45BE22, 0x4593B6, 0x4AD8BC,
		0x464216, 0x4630A1, 0x44F192, 0x44E20D, 0x44D8A3, 0x4539D2, 0x45CEA9, 0x4546A7,
		0x463E21, 0x568D36, 0x461C28, 0x4647AD, 0x44DCDB, 0x4523EA, 0x462CE2, 0x459080,
		0x45A993, 0x45CED2, 0x462088, 0x453A40, 0x454D43, 0x450188, 0x4762EC, 0x4608DC,
		0x561B4B, 0x45A584, 0x44E501, 0x44DEFA, 0x465388, 0x4515E9, 0x5B9456, 0x465C4C,
		0x459A13, 0x45E281, 0x451B5B, 0x463AE4, 0x55EF36, 0x44F5B0, 0x466521, 0x45C291,
		0x45B3E0, 0x45FC56, 0x5D8A96, 0x4634B1, 0x463EBD, 0x4516DE, 0x45EDE6, 0x44FD1E,
		0x45A95C, 0x4563EE, 0x454FC9, 0x561B06, 0x5DA9E1, 0x4B1531, 0x561B3D, 0x44DAAE,
		0x460C65, 0x45FBE7, 0x45C32A, 0x45C605, 0x465D01, 0x45F097, 0x460126, 0x450220,
		0x5D21AE, 0x45666D, 0x45DC95, 0x453862, 0x5DAE02, 0x4B3C88, 0x4540FB, 0x4521EC,
		0x590CC3, 0x460967, 0x45616C, 0x462A9D, 0x45D468, 0x4514B4, 0x44FFB0, 0x464086,
		0x454C00, 0x45EDBD, 0x45E9C5, 0x45E380, 0x44E44D, 0x44DFCC, 0x459AFB, 0x453542,
		0x57D82A, 0x45D5DC, 0x4538D1, 0x5D2067, 0x4629B7, 0x454C29, 0x4F51FC, 0x5026F1,
		0x4DAB04, 0x45F37A, 0x466957, 0x59FE2C, 0x45877C, 0x4535C9, 0x458C36, 0x44D959,
		0x459C13, 0x458BBD, 0x4536BE, 0x45DC5E, 0x454B53, 0x462C1B, 0x45BA59, 0x455ED4,
		0x4601A3, 0x4595C1, 0x45DB2B, 0x451C08, 0x45407B, 0x45B267, 0x45E53A, 0x5657FF,
		0x450059, 0x451862, 0x453B40, 0x44F872, 0x461E2B, 0x460E70, 0x45EC5B, 0x451649,
		0x45DDAF, 0x44F393, 0x454854, 0x455E10, 0x5D2082, 0x57E39A, 0x4505A9, 0x4661C0,
		0x459313, 0x462A36, 0x45CB81, 0x44EAD4, 0x4561EE, 0x57DE24, 0x4E42F9, 0x462F55,
		0x453D68, 0x45FAB6, 0x462824, 0x465781, 0x45490D, 0x463415, 0x45964A, 0x465FD0,
		0x453419, 0x464703, 0x4639BE, 0x45D8A2, 0x46593E, 0x45CDB4, 0x45885F, 0x4660AB,
		0x465F53, 0x4630F4, 0x45DAA9, 0x465AB2, 0x50227D, 0x5D599E, 0x45F586, 0x55EAB5,
		0x45E00A, 0x46493F, 0x5DA444, 0x45CFAA, 0x462DD2, 0x462470, 0x5D633A, 0x45E3A9,
		0x465443, 0x45D294, 0x44DC25, 0x464F1E, 0x44E082, 0x452FDF, 0x4565EC, 0x5DAC35,
		0x55CB3F, 0x451349, 0x465DE8, 0x464FF1, 0x45E3E6, 0x453BAE, 0x45C67D, 0x44FDC3,
		0x591F6C, 0x5D21C9, 0x5ADDB1, 0x50225D, 0x45213C, 0x5D192B, 0x456343, 0x452473,
		0x463B7E, 0x4659B0, 0x502711, 0x5DA303, 0x453EFA, 0x4610FF, 0x453201, 0x4667FB,
		0x46260F, 0x460BE6, 0x57E414, 0x462906, 0x4F6149, 0x45070E, 0x5DB151, 0x464A03,
		0x453CEF, 0x453F77, 0x45EE44, 0x45D3B0, 0x46117C, 0x502271, 0x45BC74, 0x462C69,
		0x452EFE, 0x451911, 0x45ABAA, 0x463922, 0x4665D1, 0x45560D, 0x4AE6E8, 0x4ADEAC,
		0x453265, 0x459CAC, 0x44FA73, 0x45FD31, 0x45052D, 0x463FEC, 0x4ADE22, 0x465E65,
		0x44D73E, 0x5D59CB, 0x4AF1A8, 0x45F860, 0x44F9CB, 0x45B7AD, 0x502705, 0x451FA8,
		0x466128, 0x462273, 0x455576, 0x47668A, 0x4533AB, 0x44F2EB, 0x45CAC8, 0x465A39,
		0x462E5A, 0x46584B, 0x5DB002, 0x45FDB6, 0x4E4315, 0x44E2C1, 0x452044, 0x459013,
		0x5B3367, 0x455D2F, 0x44EF18, 0x4635E2, 0x45ADF0, 0x462EEE, 0x44EBCB, 0x46367C,
		0x45D609, 0x46623D,

		// 4 refs to Current_Unit_X
		0x46740E, 0x5654DF, 0x461D0B, 0x467185,

		// 4 refs to unit y
		0x46718B, 0x467413, 0x461D10, 0x5654E5,

		// 4 refs to current unit
		0x467191, 0x5654EB, 0x461CFE, 0x467408,

		// 4 refs to current unit civ id
		0x467197, 0x461D15, 0x5654F1, 0x467418,

		// 4 refs to flags
		0x5654F7, 0x46719D, 0x46741D, 0x461D04,

		// 8 refs to data1
		0x57D7F1, 0x461F16, 0x467347, 0x46754D, 0x46755E, 0x461CBE, 0x467371, 0x461CDE,
...
apply_machine_code_edits (struct c3x_config const * cfg)
{
	...
	if ((is->trade_net == p_original_trade_net) && ((trade_net_refs = load_trade_net_refs ()) != NULL)) {
		...
		for (int n_ref = 0; n_ref < 315; n_ref++) {
			int addr = trade_net_refs[n_ref];
