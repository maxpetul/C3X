...
# Terrain & Cities
python civ3_daynight.py --data "$ART_PATH" --noon "1200" --light-key "$LIGHT_KEY" \
  --warmth 1.3  --blue 1.15 --darkness 1.12 --desat 0.8  --sat 1.08 --contrast 1.04 
  #--sunrise-center 5.0 --sunset-center 20.0 --twilight-width 1.8
