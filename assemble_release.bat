...
echo !!!
7z.exe a NEW_RELEASE.zip "Art/*.pcx" "Art/*.txt" "Art/interface" lend tcc Text C3X.h changelog.txt civ_prog_objects.csv trade_net_addresses.txt Civ3Conquests.h default.c3x_config.ini ep.c injected_code.c common.c INSTALL.bat README.txt RUN.bat "Trade Net X/TradeNetX.dll" "Trade Net X/TradeNetX.cpp" "Trade Net X/Civ3Conquests.hpp" "Trade Net X/BUILD.bat" "Trade Net X/TRADE NET X INFO.txt" "AMB Editor/*.c" "AMB Editor/*.h" "AMB Editor/RUN.bat" "AMB Editor/README.txt" "AMB Editor/amb_editor.ini" "Art/Districts/Summer/1200" "Art/Districts/*.pcx" "default.districts_config.txt" "default.districts_natural_wonders_config.txt" "default.districts_wonders_config.txt" "default.tile_animations.txt" "Art/Animations/*/*"
pause
