...
typedef enum city_form_rect
{
  ...
  CFR_FOOD_STORAGE,
  CFR_FOOD_CONSUMPTION,
  CFR_INCOME,
  CFR_GOLD_INCOME,
  CFR_SCIENCE_INCOME,
  CFR_LUXURY_INCOME,
  CFR_POLLUTION_WASTES,
  CFR_FOOD_STORAGE_INDICATOR,
  CFR_PRODUCTION_STORAGE_INDICATOR,
  CFR_PRODUCTION_BUTTON,
  CFR_AERIAL_VIEW_BUTTON,
  CFR_UNKNOWN_2, // Negative position, zero dimensions
  CFR_CLOSE_BUTTON,
  CFR_LEFT_ARROW_BUTTON,
  CFR_RIGHT_ARROW_BUTTON,
  CFR_DRAFT_BUTTON,
  CFR_GOVERNOR_BUTTON,
  CFR_STRATEGIC_RESOURCES,
  CFR_HURRY_BUTTON,
  CFR_IMPROVEMENTS,
  CFR_LUXURIES, // Negative height
  CFR_CULTURE,
  CFR_UNITS,
  CFR_POLLUTION,
  CFR_LOWER_PANE,
  CFR_ABOVE_LOWER_PANE,
  CFR_BELOW_UPPER_PANE,
  CFR_PRODUCTION_OPTIONS,
  CFR_MAP_VIEW,
